...
// // // // //     { number: "500+", label: "Premium Products", icon: <FaShoppingBag /> },
// // // // //     { number: "50+", label: "Brand Partners", icon: <FaStar /> },
...
// // // // //     {
// // // // //       title: "Sustainable Choice",
// // // // //       description: "Committed to eco-friendly practices and sourcing.",
// // // // //       icon: <FaLeaf className="text-3xl" />,
// // // // //     },
// // // // //     {
// // // // //       title: "Innovation",
// // // // //       description: "Always evolving with the latest trends & tech.",
// // // // //       icon: <IoRocket className="text-3xl" />,
// // // // //     },
// // // // //   ];
...
// // // // //           <div className="relative">
// // // // //             <div className="w-24 h-24 rounded-full bg-[#D7C097] animate-pulse" />
// // // // //             <FaGlobeAmericas className="absolute inset-0 m-auto text-4xl text-white" />
// // // // //           </div>
// // // // //         </div>
// // // // //       )}
...
// // // // //         >
// // // // //           <div className="inline-flex w-24 h-24 rounded-full bg-[#D7C097] items-center justify-center mb-8">
// // // // //             <FaGlobeAmericas className="text-4xl text-white" />
// // // // //           </div>

// // // // //           <h1 className="text-5xl lg:text-7xl font-bold mb-6 text-gray-900 dark:text-gray-100">
// // // // //             Our Story
// // // // //           </h1>

// // // // //           <p className="text-xl lg:text-3xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
// // // // //             Redefining online shopping with passion and quality
// // // // //           </p>
// // // // //         </motion.section>
...
// // // // //                 className="text-center p-8 rounded-3xl bg-white dark:bg-gray-800 border"
// // // // //               >
// // // // //                 <div className="w-20 h-20 rounded-full bg-[#D7C097] flex items-center justify-center mx-auto mb-6 text-white text-3xl">
// // // // //                   {stat.icon}
// // // // //                 </div>
...
// // // // //                 accessible while delivering outstanding service.
// // // // //               </p>

// // // // //               <div className="flex flex-wrap gap-4">
// // // // //                 {[FaShippingFast, FaShieldAlt, FaAward].map((Icon, i) => (
// // // // //                   <div
// // // // //                     key={i}
// // // // //                     className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800"
// // // // //                   >
// // // // //                     <Icon className="text-[#D7C097]" />
...
// // // // //                 >
// // // // //                   <div className="w-20 h-20 rounded-full bg-[#D7C097] flex items-center justify-center mb-6 text-white">
// // // // //                     {value.icon}
// // // // //                   </div>
...
// // // //     {
// // // //       title: "Innovation",
// // // //       description: "Always evolving with the latest trends.",
// // // //       icon: <IoRocket className="text-3xl" />,
// // // //     },
// // // //   ];
...
// // // //             className="w-24 h-24 rounded-full bg-[#D7C097] flex items-center justify-center"
// // // //           >
// // // //             <FaGlobeAmericas className="text-4xl text-white" />
// // // //           </motion.div>
// // // //         </div>
...
// // // //             className="inline-flex w-24 h-24 rounded-full bg-[#D7C097] items-center justify-center mb-8"
// // // //           >
// // // //             <FaGlobeAmericas className="text-4xl text-white" />
// // // //           </motion.div>
...
// // // //           whileInView="visible"
// // // //           viewport={{ once: true }}
// // // //           className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24"
// // // //         >
// // // //           {stats.map((stat, i) => (
// // // //             <motion.div
// // // //               key={i}
...
// // // //               className="p-8 rounded-3xl bg-white dark:bg-gray-800 border text-center transition-shadow hover:shadow-xl"
// // // //             >
// // // //               <div className="w-20 h-20 rounded-full bg-[#D7C097] mx-auto flex items-center justify-center text-white text-3xl mb-6">
// // // //                 {stat.icon}
// // // //               </div>
...
// // // //           whileInView="visible"
// // // //           viewport={{ once: true }}
// // // //           className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-20 items-center mb-24"
// // // //         >
// // // //           <motion.div variants={magicFadeUp}>
// // // //             <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-gray-900 dark:text-gray-100">
// // // //               Creating Exceptional Shopping Experiences
// // // //             </h2>
// // // //             <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
// // // //               Founded in 2025, we aim to make premium products accessible while
...
// // // //               className="p-8 rounded-3xl bg-white dark:bg-gray-800 border hover:shadow-xl"
// // // //             >
// // // //               <div className="w-20 h-20 rounded-full bg-[#D7C097] flex items-center justify-center text-white mb-6">
// // // //                 {v.icon}
// // // //               </div>
// // // //               <h3 className="text-2xl font-bold mb-3 text-gray-900 dark:text-gray-100">
// // // //                 {v.title}
...
// // //             className="inline-flex w-24 h-24 rounded-full bg-[#D7C097] mb-8 items-center justify-center"
// // //           >
// // //             <FaGlobeAmericas className="text-4xl text-white" />
// // //           </motion.div>
...
// // //             className="text-5xl lg:text-7xl font-bold mb-6 text-gray-900 dark:text-gray-100"
// // //           >
// // //             Our Story
// // //           </motion.h1>
...
// // //           <motion.p
// // //             variants={textAnim}
// // //             className="text-xl lg:text-3xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto"
// // //           >
...
// // //               variants={cardAnim}
// // //               whileHover={{ y: -8, scale: 1.03 }}
// // //               className="p-8 text-center rounded-3xl bg-white dark:bg-gray-800 border hover:shadow-xl"
// // //             >
// // //               <div className="w-20 h-20 mx-auto rounded-full bg-[#D7C097] flex items-center justify-center text-white text-3xl mb-6">
// // //                 {stat.icon}
// // //               </div>
...
// // //             <motion.h2
// // //               variants={headingAnim}
// // //               className="text-3xl lg:text-5xl font-bold mb-6 text-gray-900 dark:text-gray-100"
// // //             >
// // //               Creating Exceptional Shopping Experiences
// // //             </motion.h2>
...
// // //             >
// // //               Founded in 2025, we started with a simple vision: to make premium
// // //               products accessible to everyone. Today, we've grown into a trusted
// // //               destination for quality-conscious shoppers who value excellence,
...
// //               className="text-center p-8 rounded-3xl bg-white dark:bg-gray-800 border"
// //             >
// //               <div className="w-20 h-20 rounded-full bg-[#D7C097] flex items-center justify-center mx-auto mb-6">
// //                 <div className="text-3xl text-white">{stat.icon}</div>
// //               </div>
...
// //           whileInView="visible"
// //           viewport={{ once: true, amount: 0.3 }}
// //           className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center mb-24"
// //         >
...
// //               Founded in 2025, we started with a simple vision: to make premium
// //               products accessible to everyone. Today, we've grown into a trusted
// //               destination for quality-conscious shoppers.
// //             </p>
...
// //               className="p-8 rounded-3xl bg-white dark:bg-gray-800 border"
// //             >
// //               <div className="w-20 h-20 rounded-full bg-[#D7C097] flex items-center justify-center mb-6">
...
//   const [valuesRef, valuesControls] = useScrollAnimation();
...
//           <motion.div
//             variants={fadeUp}
//             className="inline-flex w-24 h-24 rounded-full bg-[#D7C097]  items-center justify-center"
//           >
//             <FaGlobeAmericas className="text-4xl text-white" />
//           </motion.div>
...
//               key={i}
//               variants={scaleIn}
//               className="text-center p-8 rounded-3xl bg-white dark:bg-gray-800 border shadow-sm hover:shadow-md transition-shadow duration-300"
//             >
//               <motion.div
//                 initial={{ scale: 0 }}
//                 animate={{ scale: 1 }}
...
//                   damping: 15,
//                 }}
//                 className="w-20 h-20 rounded-full bg-[#D7C097] flex items-center justify-center mx-auto mb-6"
//               >
//                 <div className="text-3xl text-white">{stat.icon}</div>
//               </motion.div>
...
//               key={i}
//               variants={fadeUp}
//               className="p-8 rounded-3xl bg-white dark:bg-gray-800 border shadow-sm hover:shadow-md transition-shadow duration-300"
//             >
//               <motion.div
//                 initial={{ rotate: -180, opacity: 0 }}
//                 animate={{ rotate: 0, opacity: 1 }}
//                 transition={{ delay: 0.2 + i * 0.1, duration: 0.6 }}
//                 className="w-20 h-20 rounded-full bg-[#D7C097] flex items-center justify-center mb-6"
//               >
//                 <div className="text-white">{value.icon}</div>
//               </motion.div>
//               <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 pt-24 pb-12">
        ...
        <motion.section
          ...
          initial="hidden"
          animate={heroControls}
          className="text-center mb-24 px-4 max-w-7xl mx-auto"
        >
          <motion.div
            variants={fadeUp}
            className="inline-flex w-24 h-24 rounded-full bg-[#D7C097] items-center justify-center"
        ...
        >
          <p className="text-gray-600 dark:text-gray-400 italic">
            Thank you for being part of our journey. Together, we're building a
