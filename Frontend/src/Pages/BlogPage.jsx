...
// //                         {/* Stats - FIXED: Use correct property names */}
// //                         <div className="flex items-center justify-between pt-4 border-t border-amber-100 dark:border-purple-900/50">
// //                           <div className="flex items-center gap-4 text-amber-600 dark:text-purple-400">
// //                             <div className="flex items-center gap-1 text-xs">
// //                               <Eye className="w-4 h-4" />
...
// //                             <div className="flex items-center gap-1 text-xs">
// //                               <MessageCircle className="w-4 h-4" />
// //                               <span>{getTotalComments(blog) || 0}</span>
// //                             </div>
// //                             <div className="flex items-center gap-1 text-xs">
// //                               <Heart className="w-4 h-4" />
// //                               <span>
// //                                 {blog.likes?.length || blog.likeCount || 0}
// //                               </span>
// //                             </div>
// //                           </div>
...
//       animate={{ opacity: 1 }}
//       transition={{ duration: 0.5 }}
//       className="min-h-screen bg-gradient-to-b from-primaryBg to-gray-100 dark:from-gray-900 dark:to-gray-800 pt-24"
//     >
//       {/* Scroll Progress Bar */}
//       <motion.div
//         className="fixed top-0 left-0 h-1 bg-gradient-to-r from-accent via-lightBg to-accent dark:from-accent/80 dark:via-lightBg/80 dark:to-accent/80 z-40"
//         style={{ width: `${scrollProgress}%` }}
//         transition={{ duration: 0.1 }}
//       />
...
//             exit={{ opacity: 0, y: 20 }}
//             onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
//             className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-accent to-lightBg dark:from-accent/90 dark:to-lightBg/90 text-gray-900 rounded-full shadow-lg flex items-center justify-center z-40 hover:shadow-xl transition-all duration-300 hover:scale-110"
//           >
//             ↑
//           </motion.button>
//         )}
...
//       {/* Hero Section */}
//       <div className="relative overflow-hidden">
//         <div className="absolute inset-0 bg-gradient-to-r from-gray-100 via-lightBg/30 to-gray-100 dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-900"></div>
//         <div className="absolute inset-0 bg-grid-gray-200/20 dark:bg-grid-gray-800/20"></div>
//         <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
//           <motion.div
//             initial={{ y: 20, opacity: 0 }}
//             animate={{ y: 0, opacity: 1 }}
...
//                 whileTap={{ scale: 0.95 }}
//                 onClick={toggleTheme}
//                 className="p-2 rounded-full bg-lightBg/20 dark:bg-gray-800 hover:bg-lightBg/40 dark:hover:bg-gray-700 transition-all duration-300 shadow-sm"
//               >
//                 {isDarkMode ? (
...
//               initial={{ scale: 0 }}
//               animate={{ scale: 1 }}
//               className="inline-flex items-center gap-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full px-4 py-2 mb-6 shadow-sm border border-gray-200 dark:border-gray-700"
//             >
//               <BookOpen className="w-4 h-4 text-accent dark:text-accent/90" />
...
//               animate={{ y: 0, opacity: 1 }}
//               transition={{ delay: 0.1 }}
//               className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-accent to-gray-900 dark:from-white dark:via-lightBg dark:to-white bg-clip-text text-transparent"
//             >
//               Fashion & Lifestyle Blog
//             </motion.h1>
...
//             >
//               <div className="relative">
//                 <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-accent dark:text-accent/90 w-5 h-5" />
//                 <input
//                   type="text"
//                   value={searchTerm}
//                   onChange={(e) => setSearchTerm(e.target.value)}
//                   placeholder="Search articles, topics, or keywords..."
//                   className="w-full pl-12 pr-4 py-4 rounded-xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-lightBg/50 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent dark:focus:ring-accent/80 focus:border-transparent shadow-sm"
//                 />
//                 <motion.button
//                   whileHover={{ scale: 1.05 }}
//                   whileTap={{ scale: 0.95 }}
//                   type="submit"
//                   className="absolute right-2 top-2 bg-gradient-to-r from-accent to-lightBg dark:from-accent/90 dark:to-lightBg/90 text-gray-900 px-6 py-2 rounded-lg hover:shadow-lg transition-all duration-300 font-medium"
//                 >
//                   Search
//                 </motion.button>
//               </div>
...
//                 whileTap={{ scale: 0.95 }}
//                 onClick={() => handleCategoryFilter("")}
//                 className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${!selectedCategory ? "bg-accent text-gray-900 shadow-md" : "bg-white/90 dark:bg-gray-800/90 hover:bg-white dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"}`}
//               >
//                 All Posts
//               </motion.button>
//               {categories.slice(0, 6).map((cat, index) => (
...
//                   whileTap={{ scale: 0.95 }}
//                   onClick={() => handleCategoryFilter(cat._id)}
//                   className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${selectedCategory === cat._id ? "bg-accent text-gray-900 shadow-md" : "bg-white/90 dark:bg-gray-800/90 hover:bg-white dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"}`}
//                 >
//                   {cat._id?.charAt(0)?.toUpperCase() + cat._id?.slice(1)} (
//                   {cat.count})
//                 </motion.button>
...
//           animate={{ x: 0, opacity: 1 }}
//           onClick={() => setShowMobileFilters(!showMobileFilters)}
//           className="w-full flex items-center justify-center gap-2 bg-white dark:bg-gray-800 border border-lightBg/50 dark:border-gray-700 rounded-lg px-4 py-3 text-gray-700 dark:text-gray-300 font-medium shadow-sm hover:shadow-md transition-all duration-300"
//         >
//           <Filter className="w-5 h-5" />
//           {showMobileFilters ? "Hide Filters" : "Show Filters"}
//           {(selectedCategory || selectedTag) && (
//             <span className="ml-2 bg-lightBg/20 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs px-2 py-1 rounded-full">
//               {selectedCategory || selectedTag}
//             </span>
//           )}
//         </motion.button>
...
//                   animate={{ y: 0, opacity: 1 }}
//                   exit={{ y: -20, opacity: 0 }}
//                   className="mb-6 bg-white dark:bg-gray-800/90 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700"
//                 >
//                   <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
//                     <div className="flex flex-wrap items-center gap-2">
...
//                           initial={{ scale: 0 }}
//                           animate={{ scale: 1 }}
//                           className="inline-flex items-center gap-1 bg-lightBg/20 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-sm"
//                         >
//                           Category: {selectedCategory}
//                           <button
//                             onClick={() => handleCategoryFilter("")}
...
//                           initial={{ scale: 0 }}
//                           animate={{ scale: 1 }}
//                           className="inline-flex items-center gap-1 bg-accent/20 dark:bg-accent/30 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-sm"
//                         >
//                           <TagIcon className="w-3 h-3" />
//                           {selectedTag}
//                           <button
...
//                           initial={{ scale: 0 }}
//                           animate={{ scale: 1 }}
//                           className="inline-flex items-center gap-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full text-sm"
//                         >
//                           <Sparkles className="w-3 h-3" />
//                           Featured
//                           <button
...
//                           initial={{ scale: 0 }}
//                           animate={{ scale: 1 }}
//                           className="inline-flex items-center gap-1 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 px-3 py-1 rounded-full text-sm"
//                         >
//                           <Flame className="w-3 h-3" />
//                           Trending
//                           <button
...
//                           initial={{ scale: 0 }}
//                           animate={{ scale: 1 }}
//                           className="inline-flex items-center gap-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-3 py-1 rounded-full text-sm"
//                         >
//                           <Search className="w-3 h-3" />
//                           {searchTerm}
//                           <button
...
//                       whileTap={{ scale: 0.95 }}
//                       onClick={clearFilters}
//                       className="text-accent dark:text-accent/90 hover:text-gray-900 dark:hover:text-gray-100 text-sm font-medium flex items-center gap-1"
//                     >
//                       Clear All <X className="w-4 h-4" />
//                     </motion.button>
//                   </div>
...
//                           : "Latest Articles"}
//                 {!loading && (
//                   <span className="text-accent dark:text-accent/90 font-normal ml-2">
//                     ({pagination.totalPosts || 0})
//                   </span>
//                 )}
//               </h2>
...
//                   whileTap={{ scale: 0.95 }}
//                   onClick={() => setShowCategoryDropdown(!showCategoryDropdown)}
//                   className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-lightBg/50 dark:border-gray-700 rounded-lg px-4 py-2 text-gray-700 dark:text-gray-300 hover:border-accent dark:hover:border-accent/80 transition-all duration-300 shadow-sm"
//                 >
//                   <Filter className="w-4 h-4" />
//                   Filter by Category
//                   <ChevronDown
...
//                     >
//                       <div className="p-4">
//                         <div className="font-medium text-gray-900 dark:text-gray-300 mb-3">
//                           Categories
//                         </div>
//                         <div className="space-y-2 max-h-60 overflow-y-auto">
//                           <motion.button
...
//                               setShowCategoryDropdown(false);
//                             }}
//                             className={`block w-full text-left px-3 py-2 rounded-lg transition-all duration-300 ${!selectedCategory ? "bg-lightBg/20 dark:bg-gray-700 text-gray-900 dark:text-gray-300" : "hover:bg-gray-100 dark:hover:bg-gray-700/50"}`}
//                           >
//                             All Categories
//                           </motion.button>
//                           {categories.map((cat, index) => (
...
//                                 setShowCategoryDropdown(false);
//                               }}
//                               className={`block w-full text-left px-3 py-2 rounded-lg transition-all duration-300 ${selectedCategory === cat._id ? "bg-lightBg/20 dark:bg-gray-700 text-gray-900 dark:text-gray-300" : "hover:bg-gray-100 dark:hover:bg-gray-700/50"}`}
//                             >
//                               <div className="flex items-center justify-between">
//                                 <span>
//                                   {cat._id?.charAt(0)?.toUpperCase() +
//                                     cat._id?.slice(1)}
//                                 </span>
//                                 <span className="text-accent dark:text-accent/90 text-sm">
//                                   {cat.count}
//                                 </span>
//                               </div>
//                             </motion.button>
...
//                     animate={{ opacity: 1, y: 0 }}
//                     transition={{ delay: i * 0.1 }}
//                     className="bg-white dark:bg-gray-800/90 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700"
//                   >
//                     <div className="h-48 bg-gradient-to-r from-lightBg/20 to-accent/10 dark:from-gray-700 dark:to-gray-600 animate-pulse"></div>
//                     <div className="p-6">
...
//                 className="text-center py-16"
//               >
//                 <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-lightBg/20 dark:bg-gray-700 flex items-center justify-center">
//                   <Search className="w-12 h-12 text-accent dark:text-accent/90" />
//                 </div>
...
//                   whileTap={{ scale: 0.95 }}
//                   onClick={clearFilters}
//                   className="bg-gradient-to-r from-accent to-lightBg dark:from-accent/90 dark:to-lightBg/90 text-gray-900 px-6 py-3 rounded-lg hover:shadow-lg transition-all duration-300 font-medium"
//                 >
//                   Browse All Articles
//                 </motion.button>
//               </motion.div>
...
//                       whileHover={{ y: -5, scale: 1.02 }}
//                       whileTap={{ scale: 0.98 }}
//                       className="group bg-white dark:bg-gray-800/90 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-accent dark:hover:border-accent/80"
//                     >
//                       {/* Image */}
//                       <Link to={`/blog/${blog.slug}`}>
//                         <div className="relative h-48 overflow-hidden">
...
//                           <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
//                           <div className="absolute top-3 left-3">
//                             <span className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm text-gray-900 dark:text-gray-300 text-xs font-semibold px-3 py-1 rounded-full">
//                               {blog.category}
//                             </span>
//                           </div>
//                         </div>
...
//                       {/* Content */}
//                       <div className="p-6">
//                         <div className="flex items-center gap-4 text-xs text-accent dark:text-accent/90 mb-3">
//                           <div className="flex items-center gap-1">
//                             <CalendarDays className="w-3 h-3" />
//                             {formatDate(blog.publishedAt)}
//                           </div>
...
//                         <Link to={`/blog/${blog.slug}`}>
//                           <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3 group-hover:text-accent dark:group-hover:text-accent/90 line-clamp-2 transition-colors duration-300">
//                             {blog.title}
//                           </h3>
//                         </Link>
...
//                             />
//                           ) : (
//                             <div className="w-8 h-8 rounded-full bg-gradient-to-r from-accent to-lightBg dark:from-accent/90 dark:to-lightBg/90 flex items-center justify-center text-gray-900 text-xs font-bold">
//                               {blog.author?.name?.charAt(0) || "A"}
//                             </div>
//                           )}
//                           <div>
...
//                           <div className="flex items-center gap-4 text-accent dark:text-accent/90">
//                             <div className="flex items-center gap-1 text-xs">
//                               <Eye className="w-4 h-4" />
//                               <span>{blog.views || 0}</span>
//                             </div>
...
//                           <Link
//                             to={`/blog/${blog.slug}`}
//                             className="text-accent dark:text-accent/90 hover:text-gray-900 dark:hover:text-gray-100 text-sm font-medium flex items-center gap-1 group/readmore"
//                           >
//                             Read More
//                             <ChevronRight className="w-4 h-4 group-hover/readmore:translate-x-1 transition-transform" />
//                           </Link>
...
//                         }
//                         disabled={!pagination.hasPrev}
//                         className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-all duration-300"
//                       >
//                         <ChevronLeft className="w-4 h-4" />
//                         Previous
//                       </motion.button>
...
//                                 className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 ${
//                                   currentPage === pageNum
//                                     ? "bg-gradient-to-r from-accent to-lightBg dark:from-accent/90 dark:to-lightBg/90 text-gray-900 shadow-lg"
//                                     : "border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700/50"
//                                 }`}
//                               >
//                                 {pageNum}
//                               </motion.button>
...
//                       <div className="md:hidden text-sm text-accent dark:text-accent/90">
//                         Page {currentPage} of {pagination.totalPages}
//                       </div>
...
//                         ←
//                       </motion.button>
//                       <span className="px-4 text-accent dark:text-accent/90">
//                         {currentPage} / {pagination.totalPages}
//                       </span>
//                       <motion.button
//                         whileTap={{ scale: 0.95 }}
...
//                   animate={{ x: 0, opacity: 1 }}
//                   exit={{ x: 100, opacity: 0 }}
//                   className="md:hidden mb-6 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-6"
//                 >
//                   <div className="flex items-center justify-between mb-6">
...
//                     <button
//                       onClick={() => setShowMobileFilters(false)}
//                       className="text-accent dark:text-accent/90 hover:text-gray-900 dark:hover:text-gray-100"
//                     >
//                       <X className="w-5 h-5" />
//                     </button>
//                   </div>
...
//                   {/* Categories */}
//                   <div className="mb-6">
//                     <h4 className="font-medium text-gray-900 dark:text-gray-300 mb-3">
//                       Categories
//                     </h4>
//                     <div className="space-y-2">
//                       <button
...
//                         whileTap={{ scale: 0.95 }}
//                         onClick={handleFeaturedFilter}
//                         className={`px-4 py-3 rounded-lg border text-center transition-all duration-300 ${currentFeatured ? "bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300" : "border-gray-300 dark:border-gray-700 hover:border-accent dark:hover:border-accent/80"}`}
//                       >
//                         <div className="font-medium">Featured</div>
//                         <div className="text-xs text-accent dark:text-accent/90">
//                           Top stories
//                         </div>
//                       </motion.button>
//                       <motion.button
...
//                         whileTap={{ scale: 0.95 }}
//                         onClick={handleTrendingFilter}
//                         className={`px-4 py-3 rounded-lg border text-center transition-all duration-300 ${currentTrending ? "bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-800 text-red-700 dark:text-red-300" : "border-gray-300 dark:border-gray-700 hover:border-accent dark:hover:border-accent/80"}`}
//                       >
//                         <div className="font-medium">Trending</div>
//                         <div className="text-xs text-accent dark:text-accent/90">
//                           Popular now
...
//                 animate={{ y: 0, opacity: 1 }}
//                 transition={{ delay: 0.2 }}
//                 className="bg-white dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6"
//               >
//                 <h3 className="font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
//                   <BookOpen className="w-5 h-5 text-accent dark:text-accent/90" />
//                   Categories
//                 </h3>
//                 <div className="space-y-2">
//                   <motion.button
...
//                 >
//                   <h3 className="font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
//                     <TagIcon className="w-5 h-5 text-accent dark:text-accent/90" />
//                     Popular Tags
//                   </h3>
//                   <div className="flex flex-wrap gap-2">
//                     {tags.map((tag) => (
...
//                         whileTap={{ scale: 0.95 }}
//                         onClick={() => handleTagFilter(tag._id)}
//                         className={`px-3 py-1.5 rounded-full text-sm transition-all duration-300 ${selectedTag === tag._id ? "bg-accent text-gray-900 shadow-md" : "bg-lightBg/20 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-lightBg/40 dark:hover:bg-gray-600"}`}
//                       >
//                         #{tag._id} ({tag.count})
//                       </motion.button>
//                     ))}
...
//                     whileTap={{ scale: 0.95 }}
//                     onClick={handleFeaturedFilter}
//                     className={`px-4 py-3 rounded-lg border text-center transition-all duration-300 ${currentFeatured ? "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg" : "border-gray-300 dark:border-gray-700 hover:border-accent dark:hover:border-accent/80"}`}
//                   >
//                     <Sparkles className="w-5 h-5 mx-auto mb-2" />
//                     <div className="font-medium">Featured</div>
//                   </motion.button>
...
//                     whileTap={{ scale: 0.95 }}
//                     onClick={handleTrendingFilter}
//                     className={`px-4 py-3 rounded-lg border text-center transition-all duration-300 ${currentTrending ? "bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg" : "border-gray-300 dark:border-gray-700 hover:border-accent dark:hover:border-accent/80"}`}
//                   >
//                     <Flame className="w-5 h-5 mx-auto mb-2" />
//                     <div className="font-medium">Trending</div>
//                   </motion.button>
...
const BlogPage = () => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5 }}
      className="min-h-screen bg-gradient-to-b from-primaryBg to-gray-100 dark:from-gray-900 dark:to-gray-800 pt-28"
    >
      {/* Scroll Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 h-1 bg-gradient-to-r from-accent via-lightBg to-accent dark:from-accent/80 dark:via-lightBg/80 dark:to-accent/80 z-40"
