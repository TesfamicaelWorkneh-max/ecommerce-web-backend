...
const BlogPostPage = () => {
  ...
  // FIXED: Add handleSubmitReply function
  ...
  return (
    ...
    >
      {/* Scroll Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 h-1 bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 z-50"
        style={{ width: `${scrollProgress}%` }}
        transition={{ duration: 0.1 }}
      />
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="mt-2 flex items-center gap-2">
                                    <button
                                      ...
                                      className="px-4 py-1.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                                    >
                                      {submittingReply ? (
                                        <>
