...
// //           <div className="text-center">
// //             <div className="w-20 h-20 mx-auto mb-6 rounded-full border-4 border-transparent border-t-[#D7C097] border-r-[#A38C5C] animate-spin"></div>
...
// //         {/* HERO IMAGE */}
// //         <div className="absolute inset-y-0 right-0 w-full sm:w-[65%] md:relative lg:w-1/2 min-h-screen">
// //           {heroImage ? (
// //             <div className="relative w-full h-full">
// //               <img
// //                 src={getCategoryImage(heroImage)}
// //                 alt="Beauty Products"
// //                 className="w-full h-full object-cover"
// //                 loading="eager"
// //               />
...
// //         {/* LEFT CONTENT */}
// //         <div className="relative z-20 flex items-center min-h-screen px-4 sm:px-6 lg:px-12 xl:px-16 w-full sm:w-[55%] lg:w-1/2">
// //           <div className="max-w-xl space-y-8">
// //             {/* HEADING */}
// //             <div>
// //               <div className="text-5xl sm:text-6xl lg:text-7xl font-bold">
// //                 <span className="text-[#6E2222] block">Radiant Beauty</span>
// //                 <span className="text-[#D7C097] block mt-4">Starts Within</span>
// //               </div>
// //             </div>
...
// //                   <div className="text-3xl font-bold text-[#6E2222] mb-1">
// //                     {stat.value}
// //                   </div>
...
// //               <button
// //                 onClick={handleShopNow}
// //                 className="mt-4 px-9 py-4 rounded-xl bg-[#D7C097] text-gray-900 font-semibold flex items-center gap-3 text-lg"
// //               >
// //                 <FaShoppingBag />
// //                 <span>Shop Now</span>
// //                 <FaArrowRight />
...
const Home = () => {
  ...
  useEffect(() => {
    const fetchHeroImage = async () => {
      try {
        ...
        setTimeout(() => {
          setLoading(false);
          // Add small delay before showing content for better animation sequence
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Background Image - Darkened for better contrast */}
            ...
            >
              <div className="relative">
                <motion.div
                  ...
                  className="w-24 h-24 mx-auto mb-6 rounded-full border-4 border-transparent border-t-accent border-r-accent/50"
                />
                <div className="absolute inset-0 flex items-center justify-center">
                  <FaHeart className="text-accent text-2xl animate-pulse" />
                </div>
              </div>
              <motion.p
      ...
      <div className="relative min-h-screen flex flex-col lg:flex-row">
        ...
        <motion.div
          ...
          className="relative z-20 flex items-center min-h-screen px-4 sm:px-6 lg:px-12 xl:px-16 w-full lg:w-1/2"
        >
          <div className="max-w-xl space-y-8">
            {/* HEADING */}
            <motion.div variants={itemAnimation}>
              <div className="text-6xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold">
                <motion.span
                  initial={{ opacity: 0, x: -50 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: 0.5, duration: 0.8 }}
                  className="text-white block max-sm:text-7xl"
                >
                  Radiant Beauty
                </motion.span>
                <motion.span
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: 0.7, duration: 0.8 }}
                  className="text-accent block mt-4"
                >
                  Starts Within
                </motion.span>
              </div>
            ...
            >
              {stats.map((stat, i) => (
                <motion.div
                  ...
                  className=""
                >
                  <div className="text-4xl sm:text-4xl font-bold text-white mb-1">
                    {stat.value}
                  </div>
                  <div className="text-xl sm:text-2xl text-white/80">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
            ...
            <motion.div variants={buttonAnimation}>
              <motion.button
                ...
                animate={contentLoaded ? "visible" : "hidden"}
                whileHover="hover"
                className="group px-8 py-4 rounded-xl bg-accent text-dark font-semibold flex items-center gap-3 text-lg shadow-2xl"
              >
              ...
              <motion.p
                ...
                animate={{ opacity: 1 }}
                transition={{ delay: 1 }}
                className="text-sm text-white/80 mt-3 flex items-center gap-2"
              >
        ...
        {/* HERO IMAGE - Animated from far to front */}
        <motion.div
          initial="hidden"
          animate={contentLoaded ? "visible" : "hidden"}
          variants={imageAnimation}
          className="absolute inset-y-0 right-0 w-full lg:w-1/2 min-h-screen lg:relative z-10"
        >
          {/* Gradient Overlay for Image */}
          <div className="absolute inset-0 z-10 bg-gradient-to-l from-dark/20 via-transparent to-transparent" />
          ...
          {heroImage ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-dark/30 to-accent/20" />
          )}
        </motion.div>
